...
const Productdetails = () => {
    ...
    console.log('hey',product?product.id : 'not here ')
            ...
            <div style={{ display: 'flex', gap: '40px' }}>
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    <div style={{
                        ...
                        <img src={product? product.images[0]:'not found'} alt="cd" />
                        {/* <Image
                            src={product? product.images[0]:'not found'}
                            alt="PlayStation 5"
                            width={100}
                            height={400}
                        /> */}
                    ...
                    <div style={{
                     ...
                     <img src={product? product.images[1]:'not found'} alt="cd" />
                    ...
                    <img src={product? product.images[2]:'not found'} alt="cd" />
               ...
               <img src={product? product.images[0]:'not found'} alt="cd" />
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    <div>
                        <p><b>{product? product.productname:'not found'}</b></p>
                    </div>
                    <div style={{ marginTop: '10px' }}>
                        <p style={{ fontSize: 'x-small', color: '#00FF66' }}>In Stock</p>
                    </div>
                    <div>
                        <p style={{ marginTop: '10px', fontWeight: '200px', fontSize: 'large' }}>{product? product.price:'not found'}</p>
                    </div>
                    <div style={{ width: '380px', borderBottom: '1px solid grey', paddingBottom: '40px' }}>
                        <p style={{ fontSize: 'small' }}>{product? product.description:'not found'}</p>
                    </div>
